...
% plot figure 2d
[rr zz] = meshgrid(fig2d.r, fig2d.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
...
% plot figure 2h
[rr zz] = meshgrid(fig2h.r, fig2h.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
...
% plot figure 2i
cbar = 0:0.1:5;
[tt zz] = meshgrid(fig2i.t, fig2i.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
logne = log10(fig2i.ne);
logne(logne<min(cbar)) = min(cbar);
logne(isnan(logne) == 1) = min(cbar);
[C1 h1] = contourf(tt, zz, logne, cbar);
colorbar('eastoutside','FontSize',fSize,'YTick',[0 1 2 3 4 5],'YTickLabel',{'10^0' '10^1' '10^2' '10^3' '10^4' '10^5'});
...
xlabel('UT (hours)');
ylabel('Altitude (km)');
set(gca,'XLim',[min(fig2i.t) max(fig2i.t)]);
set(gca,'XMinorTick','on');
set(gca,'Xtick', [88*60 89*60 90*60 91*60 92*60])
set(gca,'XtickLabel', {'16:00' '17:00' '18:00' '19:00' '20:00'})
set(gca,'YLim',[60 100]);
...
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
semilogx(fig2j.ne1, fig2j.z, 'k', fig2j.ne2, fig2j.z, 'r', 'lineWidth', 1)
xlabel('Electron density (cm^{-3})');
ylabel('Altitude (km)');
set(gca,'XLim',[1e-1 1e5]);
set(gca,'XMinorTick','on');
...
% plot figure 2k
[rr zz] = meshgrid(fig2k.r, fig2k.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
logne = log10(fig2k.ne);
logne(logne<min(cbar)) = min(cbar);
logne(isnan(logne) == 1) = min(cbar);
[C2 h2] = contourf(rr, zz, logne, cbar);
colorbar('eastoutside','FontSize',fSize,'YTick',[0 1 2 3 4 5],'YTickLabel',{'10^0' '10^1' '10^2' '10^3' '10^4' '10^5'});
...
% plot figure 2l
[rr zz] = meshgrid(fig2l.r, fig2l.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
logne = log10(fig2l.ne);
logne(logne<min(cbar)) = min(cbar);
logne(isnan(logne) == 1) = min(cbar);
[C3 h3] = contourf(rr, zz, logne, cbar);
caxis([min(cbar) max(cbar)]);
...
% plot figure 2m
[tt zz] = meshgrid(fig2m.t, fig2m.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
logne = log10(fig2m.ne);
logne(logne<min(cbar)) = min(cbar);
logne(isnan(logne) == 1) = min(cbar);
[C1 h1] = contourf(tt, zz, logne, cbar);
colorbar('eastoutside','FontSize',fSize,'YTick',[0 1 2 3 4 5],'YTickLabel',{'10^0' '10^1' '10^2' '10^3' '10^4' '10^5'});
...
xlabel('UT (hours)');
ylabel('Altitude (km)');
set(gca,'XLim',[min(fig2m.t) max(fig2m.t)]);
set(gca,'XMinorTick','on');
set(gca,'Xtick', [88*60 89*60 90*60 91*60 92*60])
set(gca,'XtickLabel', {'16:00' '17:00' '18:00' '19:00' '20:00'})
set(gca,'YLim',[60 100]);
...
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
semilogx(fig2n.ne1, fig2n.z, 'k', fig2n.ne2, fig2n.z, 'r', 'lineWidth', 1)
xlabel('Electron density (cm^{-3})');
ylabel('Altitude (km)');
set(gca,'XLim',[1e-1 1e5]);
set(gca,'XMinorTick','on');
...
% plot figure 2o
[rr zz] = meshgrid(fig2o.r, fig2o.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
logne = log10(fig2o.ne);
logne(logne<min(cbar)) = min(cbar);
logne(isnan(logne) == 1) = min(cbar);
[C2 h2] = contourf(rr, zz, logne, cbar);
colorbar('eastoutside','FontSize',fSize,'YTick',[0 1 2 3 4 5],'YTickLabel',{'10^0' '10^1' '10^2' '10^3' '10^4' '10^5'});
...
% plot figure 2p
[rr zz] = meshgrid(fig2p.r, fig2p.z);
figure;
set(gca,'defaultAxesFontSize',16);
set(gca,'color',[1 1 1]);
logne = log10(fig2p.ne);
logne(logne<min(cbar)) = min(cbar);
logne(isnan(logne) == 1) = min(cbar);
[C3 h3] = contourf(rr, zz, logne, cbar);
caxis([min(cbar) max(cbar)]);
